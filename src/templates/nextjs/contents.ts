export const fileContents = {
  ...
  "icon.svg": `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 180 180" width="180" height="180"><path fill="#000000" d="M90 0 A90 90 0 1 1 90 180 A90 90 0 1 1 90 0Z"/><path fill="#ffffff" d="M90 38.04 L135 115.96 H45 Z"/></svg>`,
